...
While not strictly necessary, we do recommend you complete the week 8 ([DataLad](https://github.com/ABCD-ReproNim/exercises/blob/main/week_8/week_8_year_2_quiz.md#repronim-questions));  and week 9 ([reproducible workflows](https://github.com/ABCD-ReproNim/exercises/blob/main/week_9/week_9_year_3_quiz.md#repronim-questions)); data exercises before completing this week's ReproNim questions. For today's ReproNim portion of the Data Exercise, you will be cloning (via the command `datalad clone week9_analysis week10_analysis`), the same Study Forrest dataset that we worked with in the ReproNim portions of the previous two data exercises (https://github.com/psychoinformatics-de/studyforrest-data-structural). We will also be testing different ways of using FSL's `FIRST` again ([https://fsl.fmrib.ox.ac.uk/fsl/fslwiki/FIRST](https://fsl.fmrib.ox.ac.uk/fsl/fslwiki/FIRST)).

Instead of installing DataLad, we recommend you use  use a local version of the ABCD-ReproNim JupyterHub container: [https://neurostars.org/t/using-abcd-repronim-jupyterhub-container-locally-via-docker/17439](https://neurostars.org/t/using-abcd-repronim-jupyterhub-container-locally-via-docker/17439). Alternatively, you can work with a local, non-JupyterHub instance of DataLad by following the installation instructions here: [https://handbook.datalad.org/en/latest/intro/installation.html](https://handbook.datalad.org/en/latest/intro/installation.html).
